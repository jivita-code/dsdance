...
export default function Layout({ children }: Readonly<{ children: React.ReactNode }>) { return <html lang="en"><body><MotionController/><Header/><main>{children}</main><Footer/></body></html>; }
