...
export async function ResearchProjectIndex({ title, phase, image }: ResearchProjectIndexProps) {
  ...
  return <><PageHero eyebrow="RESEARCH" title={title} body={phase ? undefined : "Discover our diverse initiatives that blend dance, research, and education."} image={image} /><ProjectList items={projects} prefix="/research-projects" emptyTitle={title} /></>;
}
